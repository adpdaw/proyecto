...
<head>
    ...
    <link rel="stylesheet" href="assets/css/formValidate.css">
    <!-- Font awesome -->
...
<div class="w-full min-h-screen flex items-center justify-center">
    <div class="w-full h-screen flex items-center justify-center">
        <div
            class="w-full sm:w-5/6 md:w-full lg:w-1/2 xl:w-1/3 2xl:w-1/4 h-full bg-white flex items-center justify-center bg-gradient-to-r from-indigo-100 to-indigo-400 ">
            <div class="w-full px-12">
                ...
                <p class="text-center text-sm text-gray-600 mt-2">
                    ...
                    <a href="singup.html" class="text-blue-600 hover:text-blue-700 hover:underline" title="Sign In">Sign
                        in here</a>
                </p>


                <!-- Form -->
                <form class="my-8 text-sm" action="/login" method="post">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <span class="text-sm uppercase mx-6 text-gray-600">Or</span>
                    <div class="w-full h-[1px] bg-gray-500"></div>
                </div>
...
<script type="module" src="./assets/js/validateForm.js"></script>
</body>
</html>
